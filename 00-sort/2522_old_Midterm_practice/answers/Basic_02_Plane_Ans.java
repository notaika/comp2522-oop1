 ...
 */
public class Basic_02_Plane_Ans {


  // TODO 0: Create a copy of this file in the answers package.


  // TODO 1: Create three new classes as declared here
  ...
  Basic_02_Altimeter_Ans altimeter; // the thing that says how high you're flying

  public Basic_02_Plane_Ans() {
    this.altimeter = new Basic_02_Altimeter_Ans(); // starts at 0 by default
    this.fuelTank = new Basic_02_FuelTank(200); // starts with 200 fuel
    this.turbine = new Basic_02_Turbine(fuelTank, altimeter);
  }
  ...
  public static void main(String[] args) {
    Basic_02_Plane_Ans plane = new Basic_02_Plane_Ans();
    for (int i = 0; i < 39; i++) {
      plane.fly();
    }
