...
class ScoreTest
{
    ...
    void testScoreCalculation()
    {
        ...
        Score score = new Score(LocalDateTime.now(),
                                ...
                                6,
                                2,
                                1); // 6 first attempts (2 points each), 2 second attempts (1 point each)
        assertEquals(14,
                     score.getScore(),
                     "Score should be 14 points (6 * 2 + 2 * 1)");
    }
    ...
    void testToStringFormat()
    {
        ...
        assertEquals(expected,
                     score.toString(),
                     "The toString format should match the expected format.");
    }
    ...
    void testAppendAndRetrieveLargeNumberOfScores() throws IOException
    {
        ...
        assertEquals(25,
                     scores.size(),
                     "Twenty-five scores should have been read from the file.");
        for (int i = 0; i < 25; i++)
        {
            ...
            assertEquals(expectedScore,
                         scores.get(i)
                               .getScore(),
                         "Score for entry " + i + " should match the calculated value.");
        }
    }
    ...
    void testCheckForNewHighScore() throws IOException
    {
        ...
        Score score1 = new Score(LocalDateTime.now(),
                                 1,
                                 6,
                                 2,
                                 1); // 14 points
        Score score2 = new Score(LocalDateTime.now(),
                                 1,
                                 9,
                                 1,
                                 0); // 19 points
        Score.appendScoreToFile(score1,
                                SCORE_FILE);
        Score.appendScoreToFile(score2,
                                SCORE_FILE);

        // Add a new score that is NOT a high score
        Score score3 = new Score(LocalDateTime.now(),
                                 1,
                                 7,
                                 2,
                                 1); // 16 points
        Score.appendScoreToFile(score3,
                                SCORE_FILE);
        ...
        assertEquals(19,
                     highScore,
                     "The highest score should still be 19 points.");
    }
    ...
    void testNewHighScore() throws IOException
    {
        ...
        assertEquals(21,
                     highScore,
                     "The highest score should now be 21 points.");
    }
    ...
    void testAppendAndCheckMultipleReads() throws IOException
    {
        ...
        assertEquals(5,
                     scores1.size(),
                     "There should be 5 scores after the first write and read.");
        ...
        assertEquals(10,
                     scores2.size(),
                     "There should be 10 scores after the second write and read.");
    }
    ...
    void testEmptyScoreFile() throws IOException
    {
        ...
        assertTrue(scores.isEmpty(),
                   "Reading from an empty file should return an empty list.");
    }
